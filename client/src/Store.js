...
const initialState = {
  apiFilterData: {
    ...
    status: [[{ name: "Order ID", checked: false }]],
    on_status: [
      [
        {
          name: "Send order with latest fulfillment status update",
          checked: false,
        },
        {
          name: "Send order with multiple fulfillment status updates",
          checked: false,
        },
      ],
    ],
    ...
    on_update: [
      [
        ...
        {
          name: "Return updated order without any payment terms ",
          checked: false,
        },
      ],
    ],
